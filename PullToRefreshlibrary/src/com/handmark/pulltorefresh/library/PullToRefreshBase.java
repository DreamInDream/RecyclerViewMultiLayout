...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private static final long MINI_REFRESH_TIME = 1230L;
	...
	public final void onRefreshComplete() {
		if (isRefreshing()) {
			if(getHeaderLayout() instanceof JDLoadingLayout){
				final long time = System.currentTimeMillis()-refreshTime;
				if(time > MINI_REFRESH_TIME*2){
